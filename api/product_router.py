...
from api.model import Product, User, Category
from typing import List, Any
from fastapi_jwt_auth import AuthJWT
from api.schames import ProductSchema
...
async def create(product: ProductSchema, Authorize: AuthJWT = Depends(), db: Session = Depends(SessionLocal)):
    try:
        Authorize.jwt_required()
    except Exception as e:
